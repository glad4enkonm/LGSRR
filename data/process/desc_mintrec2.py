...
if __name__ == "__main__":
    ...
    raw_video_path = 'Dataset/MIntRec2.0/video_path'
    data_path = 'data/data_text/MIntRec2.0/train.tsv'
    video_caption_path = 'results/videollama2_mintrec2.tsv'
    ...
    with open(video_caption_path, 'w', newline='') as output_file:
        ...
        with open(data_path, 'r') as f:
            ...
            for i, line in tqdm(enumerate(data), total=row_count, desc="Processing videos"):
                ...
                writer.writerow([line[0], line[1], response])